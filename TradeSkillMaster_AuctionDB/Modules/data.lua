...
function Data:UpdateFromSearchResults(itemID, compactRecords, minBuyout, totalQuantity)
	...
	if not marketValue or marketValue < 0 then return end
	...
	if #dayScans[day] > 0 then
		dayScans[day] = Data:ConvertScansToAvg(dayScans[day])
	end
